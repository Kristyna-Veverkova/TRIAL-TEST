...
### Pirate
 ...
 - A pirate might have a wooden leg.
 - You must create the following methods:
    ...
    - `toString()` method:
      - if the pirate has a wooden leg, then the string that is returned by the function must look like this: Hello, I'm Jack. I have a wooden leg and 20 golds.
      - if not: Hello, I'm Jack. I still have my real legs and 20 golds. 
  
### Ship

 - It should have a list of pirates.
 - You must be able to add new pirates to the ship.
 - You must create the following methods:
   - `getPoorPirates()` which returns a list of names containing the pirates that have a wooden leg and have less than 15 golds
